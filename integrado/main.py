...
class RobotWorker(QObject):
    ...
    def __init__(self):
        ...
        self.cam = Camara(index=0, warmup_time=2)
        self.detector = None
    ...
    def run_process(self):
        ...
        try:
            ...
            while self.running:
                ...
                self.robot.move_joint(IMAGE_CAPTURE_POSITION_JOINTS, speed=1.5, accel=2) #
                ...
                decision_maker = CapDecisionMaker(JSON_OUTPUT_PATH, min_area=2000, min_confidence=0.75)
                ...
                if selected_cap_data and self.running:
                    ...
                    if self.robot.descend_until_contact(): #
                        ...
                        if deposit_target_pose: #
                            ...
                            self.robot.move_joint(deposit_target_pose, speed=1.5, accel=2)
