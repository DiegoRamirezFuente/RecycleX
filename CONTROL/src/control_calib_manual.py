...
if __name__ == "__main__":
    try:
        ...
        # 2️⃣ Introducción de coordenadas del tapón
        px = float(input("Introduce la coordenada X del tapón en píxeles: "))
        py = float(input("Introduce la coordenada Y del tapón en píxeles: "))
        ...
        # 3️⃣ Bajar hasta detectar contacto
